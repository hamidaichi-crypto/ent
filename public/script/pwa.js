function initPWA() {
	pwaDiv = document.createElement("div");
        pwaDiv.setAttribute('id', "pwadownload");
...
if (window.location.href.includes("m.mcb777")) {
$('head').append('<link rel="manifest" href="https://api.mhubconnect.com/js/manifest.json">');
